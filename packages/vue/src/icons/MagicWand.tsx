...
export default IconWrapper(
    ...
    (h: IconHelper, props: ISvgIconProps) => (
        ...
        >
            <path
                d="M44 24C44 35.0457 35.0457 44 24 44C19.7542 44 15.8174 42.677 12.5793 40.4207C10.6315 39.0634 8.93657 37.3685 7.57932 35.4207C5.32303 32.1826 4 28.2458 4 24C4 12.9543 12.9543 4 24 4C35.0457 4 44 12.9543 44 24Z"
                fill={props.colors[1]}
            />
            <path
