...
export default IconWrapper(
    ...
    (h: IconHelper, props: ISvgIconProps) => (
        ...
        >
            ...
            />
            <path
                d="M19.2954 23.7325V32.4697C19.2954 33.5068 20.1361 34.3476 21.1732 34.3476C21.5212 34.3476 21.8623 34.2509 22.1585 34.0683L30.5439 28.9004C30.9854 28.6283 31.1227 28.0499 30.8506 27.6085C30.7737 27.4837 30.6687 27.3787 30.5439 27.3018L22.1585 22.1338C21.2756 21.5897 20.1187 21.8643 19.5746 22.7472C19.3921 23.0434 19.2954 23.3845 19.2954 23.7325Z"
                fill={props.colors[3]}
