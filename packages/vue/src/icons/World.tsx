...
export default IconWrapper(
    ...
    (h: IconHelper, props: ISvgIconProps) => (
        ...
        >
            ...
            />
            <path
                d="M36 8C30.2857 12.9886 28.2899 16.0011 30.0126 17.0373C32.5967 18.5917 33.6933 16.4033 36.8466 17.0373C40 17.6714 39.3173 21.9457 37.6586 21.9457C36 21.9457 27.41 20.8518 27.8426 25.865C28.2753 30.8781 33.4422 31.6203 33.4422 34.4211C33.4422 36.2883 32.299 39.146 30.0126 42.9942"
                stroke={props.colors[0]}
                stroke-width={props.strokeWidth}
