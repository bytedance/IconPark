...
export default IconWrapper('analysis', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<path d="M44 5H4V17H44V5Z" fill="#09C8E2"/>'
        + '<path d="M44 5H4V17H44V5Z" fill="' + props.colors[1] + '"/>'
        + '<path d="M44 5H4V17H44V5Z" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
