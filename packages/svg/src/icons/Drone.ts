...
export default IconWrapper('drone', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<rect x="19" y="19" width="10" height="10" fill="#09C8E2"/>'
        + '<rect x="19" y="19" width="10" height="10" fill="' + props.colors[1] + '"/>'
        + '<rect x="19" y="19" width="10" height="10" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
