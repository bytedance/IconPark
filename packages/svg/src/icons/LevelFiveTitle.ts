...
export default IconWrapper('level-five-title', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<path d="M42 22.0093H33V29.0341C34.2658 28.2387 35.0475 28.0243 37.016 28.0243C39.516 28.0243 42 29.2952 42 33.0002C42 36.7051 39.1532 38.0033 37.016 38.0033C36.1032 38.0033 35.1991 37.7793 34.5621 37.2782C33.9252 36.777 33.183 36.0002 33 35.0078" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
    + '</svg>'
));
