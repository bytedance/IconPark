...
export default IconWrapper('peoples', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        + '<g>'
            ...
            + '<path d="M32.6076 7C34.6404 8.2249 36 10.4537 36 13C36 15.5463 34.6404 17.7751 32.6076 19" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
            ...
            + '<path d="M44 42V40.8C44 36.3196 44 34.0794 43.1281 32.3681C42.3611 30.8628 41.1372 29.6389 39.6319 28.8719" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
        + '</g>'
    + '</svg>'
));
