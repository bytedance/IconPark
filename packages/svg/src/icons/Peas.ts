...
export default IconWrapper('peas', (props: ISvgIconProps) => (
    '<?xml version="1.0" encoding="UTF-8"?>'
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        + '<g clip-path="' + 'url(#' + props.id + '4e9242f6' + ')' + '">'
            + '<path d="M27 12C27 12 33.9994 19 33.9995 28C33.9996 37 29.5554 44.2228 25.9995 44C22.4437 43.7772 18.9999 37 20 28C21 19 27 12 27 12Z" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
            ...
            + '<circle cx="27.2432" cy="27.4078" r="2.5" fill="' + props.colors[0] + '"/>'
            + '<circle cx="26.2432" cy="34.4078" r="2.5" fill="' + props.colors[0] + '"/>'
        + '</g>'
        + '<defs>'
            + '<clipPath id="' + props.id + '4e9242f6' + '">'
