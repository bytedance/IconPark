...
export default IconWrapper('ranking', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<rect x="4" y="18" width="13" height="24" fill="' + props.colors[1] + '"/>'
        ...
        + '<rect x="17" y="6" width="13" height="36" fill="' + props.colors[1] + '"/>'
        ...
        + '<rect x="30" y="26" width="13" height="16" fill="' + props.colors[1] + '"/>'
