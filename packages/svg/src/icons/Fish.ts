...
export default IconWrapper('fish', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        + '<g clip-path="' + 'url(#' + props.id + '2b7766f6' + ')' + '">'
            ...
            + '<path d="M37.9993 25.7649C44.6625 19.7001 40.1249 8.09147 40.1249 8.09147C40.1249 8.09147 28.1079 4.55981 22.4511 10.2167C16.7942 15.8735 15.38 32.8441 15.38 32.8441C15.38 32.8441 31.3362 31.8297 37.9993 25.7649Z" fill="' + props.colors[1] + '" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
            + '<path d="M38.0075 25.773C38.0075 25.773 31.29 24.7124 27.4009 20.8233C23.5118 16.9342 22.4512 10.2167 22.4512 10.2167" stroke="' + props.colors[2] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
            + '<circle cx="33.7656" cy="14.4593" r="2" transform="rotate(45 33.7656 14.4593)" fill="' + props.colors[2] + '"/>'
            + '<path d="M40.9998 20.9448C40.4591 22.7045 39.5215 24.3794 37.9993 25.7649C36.3518 27.2643 34.1363 28.4551 31.7344 29.3981" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
