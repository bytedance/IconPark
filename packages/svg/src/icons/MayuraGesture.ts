...
export default IconWrapper('mayura-gesture', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<path d="M26.0073 20.0195V19.0195C26.0073 17.3627 27.3505 16.0195 29.0073 16.0195C30.6642 16.0195 32.0073 17.3627 32.0073 19.0195V20.0195" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
    + '</svg>'
));
