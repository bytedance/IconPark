...
export default IconWrapper('mayura-gesture', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<path d="M14.0061 24.0002V10.0002C14.0061 8.34567 15.3474 7.00439 17.0019 7.00439C17.0033 7.00439 17.0047 7.0044 17.0061 7.0044C18.6636 7.0067 20.0061 8.35105 20.0061 10.0086V24.0002" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
        + '<path d="M26.0072 20.0195V19.0195C26.0072 17.3627 27.3503 16.0195 29.0072 16.0195C30.6641 16.0195 32.0072 17.3627 32.0072 19.0195V20.0195" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
    + '</svg>'
));
