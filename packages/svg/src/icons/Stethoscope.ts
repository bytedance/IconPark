...
export default IconWrapper('stethoscope', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<circle cx="40" cy="19" r="4" fill="#09C8E2"/>'
        + '<circle cx="40" cy="19" r="4" fill="' + props.colors[1] + '"/>'
        + '<circle cx="40" cy="19" r="4" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
