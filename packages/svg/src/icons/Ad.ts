...
export default IconWrapper('ad', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<path d="M21.1429 28L18 17L14.8571 28H21.1429Z" fill="#09C8E2"/>'
        ...
        + '<path d="M35 24C35 29 31.4183 31 27 31V17C31.4183 17 35 19 35 24Z" fill="#09C8E2"/>'
        + '<path d="M35 24C35 29 31.4183 31 27 31V17C31.4183 17 35 19 35 24Z" fill="' + props.colors[1] + '"/>'
        + '<path d="M35 24C35 29 31.4183 31 27 31V17C31.4183 17 35 19 35 24Z" stroke="' + props.colors[2] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
    + '</svg>'
));
