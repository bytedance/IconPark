...
export default IconWrapper('direction', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        + '<g clip-path="' + 'url(#' + props.id + 'b7a6c812' + ')' + '">'
            ...
            + '<path d="M24.7065 37.435L27.9491 34.1924C28.5791 33.5624 28.1329 32.4853 27.242 32.4853H20.7568C19.8658 32.4853 19.4197 33.5624 20.0496 34.1924L23.2923 37.435C23.6828 37.8255 24.316 37.8255 24.7065 37.435Z" fill="' + props.colors[2] + '"/>'
