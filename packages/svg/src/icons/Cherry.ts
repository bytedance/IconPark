...
export default IconWrapper('cherry', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        + '<circle cx="14" cy="34" r="8" fill="#2E88FF" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '"/>'
        + '<circle cx="35" cy="37" r="7" fill="#2E88FF" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '"/>'
