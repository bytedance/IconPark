...
export default IconWrapper('list-checkbox', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        + '<path fill-rule="evenodd" clip-rule="evenodd" d="M20 24H44Z" fill="' + props.colors[1] + '"/>'
        ...
        + '<path fill-rule="evenodd" clip-rule="evenodd" d="M20 38H44Z" fill="' + props.colors[1] + '"/>'
        ...
        + '<path fill-rule="evenodd" clip-rule="evenodd" d="M20 10H44Z" fill="' + props.colors[1] + '"/>'
