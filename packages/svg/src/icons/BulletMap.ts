...
export default IconWrapper('bullet-map', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<path d="M16 40V9C16 7.89543 17.0534 7 18.3529 7H33.6471C34.9466 7 36 7.89543 36 9V40" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '"/>'
