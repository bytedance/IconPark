...
export default IconWrapper('data', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        ...
        + '<ellipse cx="24" cy="10" rx="20" ry="6" fill="#09C8E2"/>'
        + '<ellipse cx="24" cy="10" rx="20" ry="6" fill="' + props.colors[1] + '"/>'
        + '<ellipse cx="24" cy="10" rx="20" ry="6" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '" stroke-linejoin="' + props.strokeLinejoin + '"/>'
    + '</svg>'
));
