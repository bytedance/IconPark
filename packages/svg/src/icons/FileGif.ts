...
export default IconWrapper('file-gif', (props: ISvgIconProps) => (
        ...
        + '<g>'
            + '<g>'
                ...
                + '<g transform="translate(8.000000, 4.000000)">'
                    ...
                    + '<polyline stroke="' + props.colors[2] + '" stroke-linecap="' + props.strokeLinecap + '" points="23.0083333 14 9 14 9 30 23.0083333 30 23.0083333 23.0083363 18 23.0083363" stroke-linejoin="' + props.strokeLinejoin + '" stroke-width="' + props.strokeWidth + '" fill="none" fill-rule="evenodd"/>'
                + '</g>'
            + '</g>'
        + '</g>'
    + '</svg>'
