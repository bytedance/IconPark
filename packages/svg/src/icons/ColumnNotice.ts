...
export default IconWrapper('column-notice', (props: ISvgIconProps) => (
    ...
    + '<svg width="' + props.size + '" height="' + props.size + '" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">'
        + '<g>'
            ...
            + '<g>'
                ...
                + '<path d="M34.2359 41.1857C40.0836 37.6953 44 31.305 44 24C44 16.8084 40.2043 10.5034 34.507 6.979" stroke="' + props.colors[0] + '" stroke-width="' + props.strokeWidth + '" stroke-linecap="' + props.strokeLinecap + '"/>'
            + '</g>'
        + '</g>'
    + '</svg>'
));
