...
export default IconWrapper(
    ...
    (props: ISvgIconProps) => (
        ...
        >
            ...
            />
            <path
                d="M21.7072 24.0083C17.9024 27.4666 16.2808 30.6674 16.8423 33.6109C17.3258 36.1448 19.2483 37.3764 20.6965 37.7735C21.8192 38.0814 23.7632 38.2536 25.5 36.7067C27.3398 35.0682 26.6067 32.7388 23.9388 29.8571C22.8134 28.6415 22.0695 26.6919 21.7072 24.0083Z"
                fill={props.colors[3]}
